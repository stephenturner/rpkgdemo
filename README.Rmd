...
To follow along the full tutorial you'll need [**R**](https://www.r-project.org/), [**Positron**](https://positron.posit.co/), [**RTools**](https://cran.r-project.org/bin/windows/Rtools/) (if you're on Windows), the following packages installed:
