...
You'll also want to make sure git is installed on your system, and that you have a GitHub account set up. I also recommend setting up an SSH key (<https://github.com/settings/keys>) for pushing code to GitHub.
